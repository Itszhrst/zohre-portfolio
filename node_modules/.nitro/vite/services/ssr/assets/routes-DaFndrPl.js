...
import { ArrowRight, ArrowUp, ArrowUpRight, Atom, Boxes, Braces, Clock, Cloud, Code2, Figma, FileCode2, GitBranch, Github, Hexagon, Instagram, Linkedin, Mail, MapPin, Menu, Moon, Palette, Phone, Send, Sparkles, Sun, Terminal, Wind, X, Zap } from "lucide-react";
//#region src/components/portfolio/site-header.tsx
var NAV = [
	"Home",
	"About",
	"Services",
			...
			children: [
				/* @__PURE__ */ jsxs("a", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("span", { className: "hidden h-6 w-px bg-border sm:block" }),
						/* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsx("nav", {
					...
					children: NAV.map((item, i) => /* @__PURE__ */ jsxs("a", {
						...
						children: [item, i === 0 && /* @__PURE__ */ jsx("span", { className: "absolute -bottom-2 left-0 h-px w-full bg-primary" })]
					}, item))
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("button", {
							...
							children: mounted ? theme === "dark" ? /* @__PURE__ */ jsx(Sun, { className: "size-4" }) : /* @__PURE__ */ jsx(Moon, { className: "size-4" }) : /* @__PURE__ */ jsx(Moon, { className: "size-4" })
						}),
						/* @__PURE__ */ jsx("button", {
...
//#endregion
//#region src/assets/hero-portrait.png
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				className: "relative",
				children: [
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_60%_40%,oklch(0.62_0.223_297/0.35),transparent_65%)]" }),
					/* @__PURE__ */ jsx("img", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", { className: "size-2.5 animate-pulse-dot rounded-full bg-primary" }), /* @__PURE__ */ jsxs("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: [/* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("path", {
								id: "badge-circle",
			...
			children: STATS.map((s) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", {
...
//#endregion
//#region src/components/portfolio/services.tsx
var SERVICES = [
	{
		icon: Sparkles,
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h2", {
				...
				children: [/* @__PURE__ */ jsxs("span", { children: [
					...
					/* @__PURE__ */ jsx("br", {}),
					"I Do"
				] }), /* @__PURE__ */ jsx(Sparkles, { className: "mt-3 size-5" })]
			}), /* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("h2", {
				...
				children: ["View all projects", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4 transition-transform group-hover:translate-x-1" })]
			})]
		}), /* @__PURE__ */ jsx("div", {
			...
			children: PROJECTS.map((p, i) => /* @__PURE__ */ jsxs("article", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
						...
						children: p.tag
					})] }), /* @__PURE__ */ jsx(ArrowUpRight, { className: "size-5 shrink-0 text-muted-foreground transition-colors group-hover:text-primary" })]
				})]
			}, p.name))
		})]
	});
...
//#endregion
//#region src/components/portfolio/toolkit-process.tsx
var TOOLS = [
	{
		icon: FileCode2,
		name: "PHP"
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: TOOLS.map((t) => /* @__PURE__ */ jsxs("li", {
							className: "group",
						...
						children: STEPS.map((s, i) => /* @__PURE__ */ jsxs("li", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("span", {
									...
									children: ["0", i + 1]
								}), i < STEPS.length - 1 && /* @__PURE__ */ jsx("span", { className: "mt-1 w-px flex-1 border-l border-dashed border-border" })]
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(Sparkles, { className: "absolute top-24 right-8 size-8 text-primary-foreground/70" }),
						/* @__PURE__ */ jsx("h2", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("p", {
								...
								children: ["Get in touch", /* @__PURE__ */ jsx(ArrowUpRight, { className: "size-4 text-primary" })]
							})]
						})
					]
				})
...
//#endregion
//#region src/components/portfolio/contact-footer.tsx
var DETAILS = [
	{
		icon: Mail,
		label: "Email",
